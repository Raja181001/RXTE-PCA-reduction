...
def process_main_directory(main_directory):
            ...
            for dir_name in dirs:
                ...
                if number_directory_pattern.match(dir_name):
                    ...
                    if os.path.isdir(pca_folder):
                        ...
                        csv_file_path = os.path.join(root, dir_name, 'xenon_data_summary.csv')
                        xdf_file_path = os.path.join(root, dir_name, 'xenon.god')
                        ...
                        try:
                            if data:
                                ...
                                # Increment the xenon.god file count
                                xenon_god_count += 1
                            else:
    ...
    # Print the total number of xenon.god files created
    print(f"\nTotal xenon.god files created: {xenon_god_count}")
